  ...
  return (
    <View style={[t`w-full h-full bg-white flex justify-center items-center`]}>
      <View style={[t`w-[360px] h-full`]}>
        <Text style={[t`text-[48px] font-bold mt-[98px]`]}>Create your</Text>
        <Text style={[t`text-[48px] font-bold text-[#999CF0]`]}>Account</Text>
        <View style={[t`mt-[78px]`]}>
          <TextInput
            style={[
              t`w-[360px] h-[60px] bg-[#F8F7FD] border-[1px] border-[#EEEEEE] rounded-[10px]`,
            ]}
            placeholder="Email"
          />
          <TextInput
            style={[
              t`w-[360px] h-[60px] bg-[#F8F7FD] border-[1px] border-[#EEEEEE] mt-[24px] rounded-[10px]`,
            ]}
          ...
          <View
            ...
            <TouchableOpacity
              style={[
                t`h-[24px] w-[24px] border-[#4448AE] rounded-[4px] border-[1px] mr-[10px]`,
              ]}></TouchableOpacity>
